    ...
    return <section id="home" className="min-h-screen flex items-center justify-center relative">
        <div className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent leading-right">
                Hi, I'm Farris Hirzan
            </h1>

            <p className="text-gray-100 text-lg max-w-3xl mx-auto">
            💻 Aspiring Web Developer | Passionate About Innovation & Problem-Solving
            
            </p>

            <p className="max-w-4xl mx-auto text-gray-100 text-lg mb-8">
                Specializing in the TALL stack <section className="bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent inline-block">(TailwindCSS, Alpine.js, Laravel, Livewire)</section>, I create modern, responsive, and dynamic web applications with optimized performance.
            </p>
